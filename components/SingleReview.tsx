  ...
  return (
    <article className="w-[900px] mx-auto py-10 max-[1000px]:w-[700px] max-[750px]:w-[90%]">
      ...
      <footer className="mb-5 text-sm text-gray-500 dark:text-gray-400">
        <p>
          Reviewed in the Abuja on <time>March 3, 2024</time>
        </p>
      </footer>
      <p className="mb-2 text-gray-500 dark:text-gray-400 max-[400px]:text-sm">
        This is my third roll up banner design . They are just fantastic value for
        money. This one arrived yesterday and the first thing I did was set the
        popped on an identical strap from another roll up and went in the
        shower with it to test the roll up .... No problems.
      </p>
      <p className="mb-3 text-gray-500 dark:text-gray-400">
        It is obviously not the same build quality as those very expensive
        roll up banner. But that is like comparing a Citroën to a Ferrari. This roll up banner
        was well under #60,000! An absolute bargain.
      </p>
      <a
        href="#"
